...
public:
    ...
    //Settings
    void SetParam(long double mtheta, long double v_h, long double lam_H, long double v_s, long double lam_phi, long double  lam_Hphi, long double mu_s); // Setting Model Parameters.
...
// Model Parameters:
    long double m_theta; // theta mass
    long double lambdaH;
