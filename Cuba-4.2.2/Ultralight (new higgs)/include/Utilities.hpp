...
long double MH2(long double lamHphi, long double lamH, long double vs, long double lamphi, long double vh );

long double MH(long double lamHphi, long double lamH, long double vs, long double lamphi, long double vh);

long double Alpha(long double lambdaHphi,long double vsigma,long double v_h,long double mH,long double mh2);

long double HHH1(long double lambdaHphi, long double lambdaH, long double vsigma, long double lambdaphi, long double vh, long double a, long double mH, long double mh2);

long double hHH2(long double lambdaHphi, long double lambdaH, long double vsigma, long double lambdaphi, long double vh, long double a, long double mH, long double mh2);

long double hhh3(long double lambdaHphi, long double lambdaH, long double vsigma, long double lambdaphi, long double vh, long double a, long double mH, long double mh2);
