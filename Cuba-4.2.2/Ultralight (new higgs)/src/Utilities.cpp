...
{
    return (lambdaphi*vsigma*pow(cos(a),3))/2. + 
...
{
    return ((3*lambdaH + lambdaHphi)*vh*cos(a) + 3*(-lambdaH + lambdaHphi)*vh*cos(3*a) + 
...
{
    return (lambdaphi*vsigma*pow(sin(a),3) + lambdaHphi*vsigma*pow(cos(a),2)*sin(a) + 
