...
###########################################################
Rate_e1 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2=mH)3.dat',unpack=True,skiprows=1)
Rate_e2 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2=mH)5.dat',unpack=True,skiprows=1)
...
axes[0].loglog(1 / Rate_e1[0, :], Rate_e1[1, :],'b-' ,lw=4, label='$\\alpha_1={}$'.format(latex_float(format(Rate_e1[6, 1],".1e"))),rasterized=True)
axes[1].loglog(1 / Rate_e2[0, :], Rate_e2[1, :], 'k-',lw=4, label='$\\alpha_2={}$'.format(latex_float(Rate_e2[6, 1])),rasterized=True)
...
axes[0].set_ylim(1.0e-60, 1.0e-35)
axes[0].set_xlim(1.0e-4, 1.0e2)

axes[1].set_ylim(1.0e-60, 1.0e-35)
