...
axes.text(32, 2e-4, r'$\boldsymbol{\Gamma/H = 1}$', color='k', fontsize=25, zorder=11, rasterized=True)
axes.text(0.02, 60, r'$M_h={}$ GeV'.format(Rate_e1[9, 1]), color='k', fontsize=20, zorder=11, rasterized=True,rotation=90)
axes.text(8e-4, 60, r'$M_{{h_2}}={}$ GeV'.format(latex_float(format(Rate_e1[8, 1],".1e"))), color='k', fontsize=18, zorder=11, rasterized=True,rotation=90)
axes.text(8e-5, 60, r'$M_{{h_2}}={}$ GeV'.format(latex_float(format(Rate_e2[8, 1],".1e"))), color='k', fontsize=18, zorder=11, rasterized=True,rotation=90)
axes.text(8e-8, 60, r'$M_{{h_2}}={}$ GeV'.format(latex_float(format(Rate_e3[8, 1],".1e"))), color='k', fontsize=18, zorder=11, rasterized=True,rotation=90)


axes.set_ylim(1.0e-35, 1.0e17)
axes.set_xlim(1.0e-8, 1.0e3)
...
fig.savefig("ratedm_greater.pdf")
#############################################################