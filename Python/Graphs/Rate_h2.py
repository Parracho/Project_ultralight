...
Rate_e3 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2=mH)3.dat',unpack=True,skiprows=1)
Rate_g1 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2>mH)1.dat',unpack=True,skiprows=1)
Rate_g2 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2>mH)2.dat',unpack=True,skiprows=1)
Rate_g3 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2>mH)3.dat',unpack=True,skiprows=1)
Rate_f1 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2<mH)1.dat',unpack=True,skiprows=1)
Rate_f2 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2<mH)2.dat',unpack=True,skiprows=1)
Rate_f3 = np.loadtxt('/home/parracho/Desktop/Project/Ultralight_Dark_Matter/Real_pseudo/Rates/New_higgs/Rates(mh2<mH)3.dat',unpack=True,skiprows=1)


#[fig, axes] = plt.subplots(nrows=1, ncols=3, figsize=(40, 15), dpi=100)
axes=[]
...
axes[0].loglog(1 / Rate_e2[0, :], Rate_e2[1, :], lw=4, label='$\\alpha_2={}$'.format(latex_float(Rate_e2[6, 1])),rasterized=True)
axes[0].loglog(1 / Rate_e3[0, :], Rate_e3[1, :], lw=4, label='$\\alpha_3={}$'.format(latex_float(Rate_e3[6, 1])))
#axes[1].loglog(1 / Rate_g1[0, :], Rate_g1[1, :], lw=4, label='$\\alpha_1={}$'.format(latex_float(Rate_g1[6, 1])))
#axes[1].loglog(1 / Rate_g2[0, :], Rate_g2[1, :], lw=4, label='$\\alpha_2={}$'.format(latex_float(Rate_g2[6, 1])))
#axes[1].loglog(1 / Rate_g3[0, :], Rate_g3[1, :], lw=4, label='$\\alpha_3={}$'.format(latex_float(Rate_g3[6, 1])))
axes[2].loglog(1 / Rate_f1[0, :], Rate_f1[1, :], lw=4, label='$\\alpha_1={}$'.format(latex_float(Rate_f1[6, 1])),rasterized=True)
#axes[2].loglog(1 / Rate_f2[0, :], Rate_f2[1, :], lw=4, label='$\\alpha_2={}$'.format(latex_float(Rate_f2[6, 1])))
#axes[2].loglog(1 / Rate_f3[0, :], Rate_f3[1, :], lw=4, label='$\\alpha_3={}$'.format(latex_float(Rate_f3[6, 1])))
...
#axes[1].set_xlim(1.0e-5, 1.0e2)

axes[2].set_ylim(1.0e-45, 1.0e-20)
