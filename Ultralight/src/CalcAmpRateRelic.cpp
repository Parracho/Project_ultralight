...
long double Rate::SqAmp(long double s, long double cc, int id)
{
    ...
    if (id == 1)
    {
       amp = 9*pow(g,2)*(pow(lamH,2)*pow(vh,4) - 2*lamH*lamphi*pow(vh,2)*pow(vs,2) + 
     4*pow(lamHphi,2)*pow(vh,2)*pow(vs,2) + lamphi*pow(vs,4))*pow(s/2. + 2*pow(mus,2),2)*
   pow(lamH*pow(vh,2) + lamphi*pow(vs,2) - pow(pow(lamH,2)*pow(vh,4) - 2*lamH*lamphi*pow(vh,2)*pow(vs,2) + 
       4*pow(lamHphi,2)*pow(vh,2)*pow(vs,2) + lamphi*pow(vs,4),0.5),2)*pow(sin(2*alpha),2);
       amp = amp/ (32*pow(MW,2)*pow(vs,4)*((pow(wh2,2)*(lamH*pow(vh,2) + lamphi*pow(vs,2) + 
       ...
       (-(lamH*pow(vh,2)) - lamphi*pow(vs,2) - 
          pow(pow(lamH,2)*pow(vh,4) + 2*(-(lamH*lamphi) + 2*pow(lamHphi,2))*pow(vh,2)*pow(vs,2) + 
            lamphi*pow(vs,4),0.5))/2.,2))*((pow(wh,2)*
        (lamH*pow(vh,2) + lamphi*pow(vs,2) - 
          pow(pow(lamH,2)*pow(vh,4) + 2*(-(lamH*lamphi) + 2*pow(lamHphi,2))*pow(vh,2)*pow(vs,2) + 
            lamphi*pow(vs,4),0.5)))/2. + pow(s + 
       (-(lamH*pow(vh,2)) - lamphi*pow(vs,2) + 
   ...
   (pow(lamH,2)*pow(vh,4) - 2*lamH*lamphi*pow(vh,2)*pow(vs,2) + 4*pow(lamHphi,2)*pow(vh,2)*pow(vs,2) + 
     lamphi*pow(vs,4))*pow(s/2. + 2*pow(mus,2),2)*pow(sin(2*alpha),2);
     amp = amp/ (pow(MW,2)*pow(vs,4)*((pow(wh2,2)*(lamH*pow(vh,2) + lamphi*pow(vs,2) + 
          pow(pow(lamH,2)*pow(vh,4) + 2*(-(lamH*lamphi) + 2*pow(lamHphi,2))*pow(vh,2)*pow(vs,2) + 
            lamphi*pow(vs,4),0.5)))/2. + pow(s + 
       (-(lamH*pow(vh,2)) - lamphi*pow(vs,2) - 
          pow(pow(lamH,2)*pow(vh,4) + 2*(-(lamH*lamphi) + 2*pow(lamHphi,2))*pow(vh,2)*pow(vs,2) + 
   ...
   (pow(lamH,2)*pow(vh,4) - 2*lamH*lamphi*pow(vh,2)*pow(vs,2) + 4*pow(lamHphi,2)*pow(vh,2)*pow(vs,2) + 
    ...
    else if (id == 11)
    {
     ...
     4*pow(lamHphi,2)*pow(vh,2)*pow(vs,2) + lamphi*pow(vs,4))*pow(s/2. + 2*pow(mus,2),2)*pow(sin(2*alpha),2);
       amp = amp/ (pow(MW,2)*pow(vs,4)*((pow(wh2,2)*(lamH*pow(vh,2) + lamphi*pow(vs,2) + 
          pow(pow(lamH,2)*pow(vh,4) + 2*(-(lamH*lamphi) + 2*pow(lamHphi,2))*pow(vh,2)*pow(vs,2) + 
            lamphi*pow(vs,4),0.5)))/2. + pow(s + 
       (-(lamH*pow(vh,2)) - lamphi*pow(vs,2) - 
   ...
   (3*pow(MW,4) + 4*pow(mus,2)*pow(MW,2)*(-1 + pow(SW,2)) + 
     ...
     (pow(s,2)*pow(-1 + pow(SW,2),2))/4.)*pow(sin(2*alpha),2);
     amp = amp/(2*pow(MW,2)*pow(vs,4)*pow(-1 + pow(SW,2),2)*((pow(wh2,2)*
        (lamH*pow(vh,2) + lamphi*pow(vs,2) + 
          pow(pow(lamH,2)*pow(vh,4) + 2*(-(lamH*lamphi) + 2*pow(lamHphi,2))*pow(vh,2)*pow(vs,2) + 
            lamphi*pow(vs,4),0.5)))/2. + pow(s + 
       (-(lamH*pow(vh,2)) - lamphi*pow(vs,2) - 
...
int IntegrandForRate(const int *ndim, const long double x[], const int *ncomp, long double ff[], void *_params)
{
    ...
    {
        m1 = params->m_theta; m2 = params->m_theta; m3 = mH; m4 = mH; S12 = 0.5l; S34=0.5l;
    }
