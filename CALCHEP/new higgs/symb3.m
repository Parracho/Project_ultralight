...
p2/: SC[p2,p2] =mh2^2;
p3/: SC[p3,p3] =Mb^2;
p2/: SC[p2,p3] = -1*(Mb^2-mh2^2-mh2^2-Mb^2-2*SC[p1,p2]+2*SC[p1,p3])/2;
...
*)
totFactor = ((3*cosa^2*Mb^2*hHH^2*EE^2)/(MW^2*SW^2));
numerator =(SC[p1,p2]-2*Mb^2+mh2^2);
...
*)
totFactor = ((-6*cosa*sina*Mb^2*hHH*HHH*EE^2)/(MW^2*SW^2));
numerator =(SC[p1,p2]-2*Mb^2+mh2^2);
...
*)
totFactor = ((3*sina^2*Mb^2*HHH^2*EE^2)/(MW^2*SW^2));
numerator =(SC[p1,p2]-2*Mb^2+mh2^2);
