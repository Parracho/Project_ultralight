...
p2/: SC[p2,p2] =mh2^2;
p3/: SC[p3,p3] =Me^2;
p2/: SC[p2,p3] = -1*(Me^2-mh2^2-mh2^2-Me^2-2*SC[p1,p2]+2*SC[p1,p3])/2;
...
*)
totFactor = ((sina^2*HHH^2*Me^2*EE^2)/(MW^2*SW^2));
numerator =(SC[p1,p2]+mh2^2-2*Me^2);
...
*)
totFactor = ((-2*cosa*sina*hHH*HHH*Me^2*EE^2)/(MW^2*SW^2));
numerator =(SC[p1,p2]+mh2^2-2*Me^2);
...
*)
totFactor = ((cosa^2*hHH^2*Me^2*EE^2)/(MW^2*SW^2));
numerator =(SC[p1,p2]+mh2^2-2*Me^2);
