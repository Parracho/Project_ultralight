...
p2/: SC[p2,p2] =Mdm^2;
p3/: SC[p3,p3] =Mtp^2;
p2/: SC[p2,p3] = -1*(Mtp^2-Mdm^2-Mdm^2-Mtp^2-2*SC[p1,p2]+2*SC[p1,p3])/2;

initSum;

(*
  Diagram  1 in subprocess 3
*)
totFactor = ((3*cosa^2*sina^2*Mh^4*Mtp^2*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Mtp^2);
denominator =(propDen[-p1-p2,Mh,wh]^2);

addToSum;

(*
  Diagram  2 in subprocess 3
*)
totFactor = ((-6*cosa^2*sina^2*mh2^2*Mh^2*Mtp^2*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Mtp^2);
...
(*
  Diagram  3 in subprocess 3
*)
totFactor = ((3*cosa^2*sina^2*mh2^4*Mtp^2*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Mtp^2);
