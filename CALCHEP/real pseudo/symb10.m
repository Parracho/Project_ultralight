(*
     ...
     *  CalcHEP  3.8.9 *
     ==============================
  process  ~dm(p1)+~dm(p2)->e(p3)+E(p4)
*)

parameters={
 EE -> 3.13330000000*10^(-1)
,Me -> 5.00000000000*10^(-4)
...
p2/: SC[p2,p2] =Mdm^2;
p3/: SC[p3,p3] =Me^2;
p2/: SC[p2,p3] = -1*(Me^2-Mdm^2-Mdm^2-Me^2-2*SC[p1,p2]+2*SC[p1,p3])/2;
...
*)
totFactor = ((cosa^2*sina^2*mh2^4*Me^2*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Me^2);
...
*)
totFactor = ((-2*cosa^2*sina^2*mh2^2*Mh^2*Me^2*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Me^2);
...
*)
totFactor = ((cosa^2*sina^2*Mh^4*Me^2*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Me^2);
