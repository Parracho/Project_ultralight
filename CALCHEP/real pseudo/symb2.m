...
*)
totFactor = ((3*cosa^2*sina^2*Mb^2*mh2^4*EE^2)/(vsigma^2*MW^2*SW^2));
...
*)
totFactor = ((-6*cosa^2*sina^2*Mb^2*mh2^2*Mh^2*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Mb^2);
...
*)
totFactor = ((3*cosa^2*sina^2*Mb^2*Mh^4*EE^2)/(vsigma^2*MW^2*SW^2));
numerator =(SC[p1,p2]+Mdm^2-2*Mb^2);
