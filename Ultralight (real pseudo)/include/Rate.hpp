...
public:
    ...
    //Settings
    void SetParam(long double mtheta,long double lambdaHphi, long double lambdaH, long double vsigma, long double lambdaphi, long double vh, long double mius); // Setting Model Parameters.
...
// Model Parameters:
    ...
    long double lambdaH;
    long double vh;
    long double lambdaphi;
    long double vsigma;
    long double lambdaHphi;
    long double mius;
    long double wh2;
    long double wh;
    long double SW;
    long double mH;
    long double mh2;
    long double lambda_H;
    long double v_h;
    long double lambda_phi;
    long double v_sigma;
    long double lambda_Hphi;    
    long double miu_s;
//------
